...
)
{
    ...
    if (iz == 0) {
        if (edge) {
            out[ind].x = 2.0*in[ind].x - in[ind + nx*ny].x;
            out[ind].y = 2.0*in[ind].y - in[ind + nx*ny].y;
        }
        else {
        ...
        out[ind].x = 2.0*in[ind].x - in[ind + nx*ny].x - in[ind - nx*ny].x;
        out[ind].y = 2.0*in[ind].y - in[ind + nx*ny].y - in[ind - nx*ny].y;
