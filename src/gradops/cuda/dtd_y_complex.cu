...
)
{
    ...
    if (iy == 0) {
        if (edge) {
            out[ind].x = 2.0*in[ind].x - in[ind + nx].x;
            out[ind].y = 2.0*in[ind].y - in[ind + nx].y;
        }
        else {
        ...
        out[ind].x = 2.0*in[ind].x - in[ind + nx].x - in[ind - nx].x;
        out[ind].y = 2.0*in[ind].y - in[ind + nx].y - in[ind - nx].y;
    }
}